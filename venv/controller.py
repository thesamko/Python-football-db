...
#
    ...
    #GroupsData
        ...
        #gd_end_time = time.time()
        #print("Full load for datesData tables completed in {:.0f} seconds".format(gd_end_time - gd_start_time))
    ...
    # StatsData
        ...
        sd_end_time = time.time()
        print("Full load for playersData tables completed in {:.0f} seconds".format(sd_end_time - sd_start_time))
